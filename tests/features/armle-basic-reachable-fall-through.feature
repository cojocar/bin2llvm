Feature: Check a basic translation for ARM little-endian architecture and function recovery (fall through)
	...
	Scenario: Check if files were generated
		...
		Then the out file "qemu-0.log" should contain "sub	r8, r0, r8"
	...
	Scenario: Check if final.ll is correct
		...
		Then the out file "final.ll" should not contain "br label"
		Then the out file "final.ll" should contain "add"
		Then the out file "final.ll" should contain "sub"
